...
class DenseTrainer(Trainer):
    def __init__(self,inf_loader,data_args,training_args,board_writer, *args, **kwargs):
        ...
        self.scores_label = []
        with open('/home/swh/legal/project/caseformer/india/dataset/test/similarity_scores_all.csv') as f:
            lines = f.read().split('\n')
    ...
    def eval(self,output_dir):
                    ...
                    for qid in qry_did_score:
                        ...
                        for i in range(0, len(candidata)):
                            ...
                            if (qid,did) not in already2:                              
                                ...
                                writer.write(f'{qid} Q0 {did} {i + 1} {score} SWH\n')
        writer.close()
        ...
        # qrel_path = '/home/swh/legal/project/sigir/dense/qrel_dense_test.trec'
        qrel_path = '/home/swh/legal/project/pretrain_legal/data/to_be_inf/qrel.trec'
